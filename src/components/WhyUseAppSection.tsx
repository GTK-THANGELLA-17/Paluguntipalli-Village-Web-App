...
import { Bell, Download, MapPin, Users, Star, Heart, X, ArrowLeft, Home } from "lucide-react";
import { motion } from "framer-motion";
import OptimizedImage from "./OptimizedImage";
import { Button } from "./ui/button";
import { useState, useEffect } from "react";

interface WhyUseAppSectionProps {
  onClose: () => void;
}
...
const features = [
  ...
  },
  {
    ...
    image: "/Peerla chavidi 1.png"
  }
];


const WhyUseAppSection: React.FC<WhyUseAppSectionProps> = ({ onClose }) => {
...
export default WhyUseAppSection;
